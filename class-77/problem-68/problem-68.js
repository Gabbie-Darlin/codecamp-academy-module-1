/*
    ...
    Solution: Calculates the final grade base on weight scores
*/
...
const student4Grade = calculateFinalGrade(77, 80, 60);
const student4Status = getStudentStatus(student4Grade);
displayStudentData(student4Grade, student4Status);