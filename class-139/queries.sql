...
--Exercise 5
-- Display onle the title and publication year of every book
...
SELECT * FROM book WHERE book.available = TRUE;
...
-- Exercise 9
-- Display all the from the United Kingdom
...
-- -- Exercise 12
-- Display all members whose name is James
SELECT * FROM member WHERE last_name = 'James';

-- Exercise 13
-- Display all loans that have not been returned yet
SELECT * FROM loan WHERE return_date = NULL;

-- Exercise 14
-- Display all loans that have been returned
...
-- Exercise 31
-- Display all books whose title contain the word "Harry"
...
-- Exerciser 35a
-- Display members who first name is "Olivia" or "Mia"
SELECT * FROM member WHERE first_name = 'Olivia' OR first_name = 'Mia';

-- Exerciser 35b
-- Display members who first name is "Kevin" or "Jaylen"
SELECT * FROM member WHERE first_name = 'Kevin' OR first_name = 'Jaylen';
------------------------------------------------------------------------
-- BONUS
