...
class BankAccount {
    ...
    desposit(amount) {
        if(isNaN(amount)) {
            ...
            return "The deposit amount must be greater or equal to $1 USD";
        } else {
            this.balance += amount;
    ...
    withdraw(amount) {
        if (isNaN(amount)) {
            return "The withdrawal amount must be a number.";
        } else if(amount < 1) {
            return "The withdrawal amount must be greater or equal to $1 USD";
...
class CheckingAccount extends BankAccount {
    ...
    chargeFee() {
        if(isNaN(this.monthlyFee)) {
            ...
            return "Monthly fee paid successfully";
        }
    }
}
...
console.log(savings);
console.log("=======================");
console.log(savings.desposit("Hello"));
console.log(savings.desposit(-23));
console.log(savings.desposit(500));
console.log("=======================");
...
// Testing checknig account
console.log("=======================");
console.log("CHECKING ACCOUNT");
console.log("=======================");
console.log(checking);
console.log("=======================");
console.log(checking.desposit("Hello"));
console.log(checking.desposit(-23));
console.log(checking.desposit(500));
console.log("=======================");
