...
class Dog {
    ...
    constructor(name, breed, age, color, sex) {
        this.name = name;
        this.breed = breed;
        this.age = age;
        this.color = color;
    ...
    play() {
        if (this.energy >= 10 && this.energy <= 100) {
            ...
            console.log(`🐶️ ${this.name} is too tired to play.`);
        }
    }
...
const pet1 = new Dog("Max", "German Shepherd", 4, "Black", "Male");
console.log(pet1);
...
const pet2 = new Dog("Tony", "Golden Retriever", 6, "Golden", "Male");
console.log(pet2);
...
const pet3 = new Dog("Loyale", "Puddle", 2, "White", "Female");
console.log(pet3);
console.log(typeof(pet3));
console.log("************************");
pet3.eat();
console.log("************************");
pet3.play();
